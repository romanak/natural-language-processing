...
from keras.layers import recurrent, LSTM, Bidirectional, Dense, merge
...
#    encoded_sentence = layers.Embedding(vocab_size, 100)(sentence)
    ...
    attention_probs = Dense(200, activation='softmax', name='attention_vec')(merged)
    attention_mul = merge([merged, attention_probs], output_shape=100, name='attention_mul', mode='mul')


    
    preds = layers.Dense(vocab_size, activation='softmax')(attention_mul)
