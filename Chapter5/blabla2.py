...
#    print keras.backend.int_shape(input_question_match),keras.backend.int_shape(Probs),keras.backend.int_shape(input_A),keras.backend.int_shape(question_B)
    ...
    plot_model(model, to_file='memnn.png')
    exit(0)
